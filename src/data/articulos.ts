...
export const articulos: Articulo[] = [
  ...
  {
    id: "3",
    slug: "del-campo-al-supermercado-pagas-mas-agricultor-cobra-menos",
    titulo: "Del campo al supermercado: por qué pagas más y el agricultor cobra menos",
    extracto: "Cada vez es más común escuchar una misma sensación en dos extremos opuestos del sistema: el consumidor percibe que los alimentos son caros, mientras que el agricultor insiste en que no le salen las cuentas. Ambos tienen razón.",
    categoria: "Cadena Alimentaria",
    categoriaColor: "bg-amber-100 text-amber-800",
    fechaPublicacion: "28 de abril de 2026",
    tiempoLectura: 7,
    autor: "Equipo ORIGEN",
    destacado: false,
    parrafos: [
      "Cada vez es más común escuchar una misma sensación en dos extremos opuestos del sistema: el consumidor percibe que los alimentos son caros, mientras que el agricultor insiste en que no le salen las cuentas. Ambos tienen razón. Y sin embargo, están conectados por una cadena que, en teoría, debería beneficiarles a los dos.",
      "Entre el campo y el supermercado ocurre algo que rara vez se explica con claridad. El producto inicia su recorrido con un valor determinado en origen, pero ese valor cambia radicalmente a medida que avanza por la cadena de distribución. No es un cambio lineal ni transparente. Es un proceso donde intervienen múltiples actores, cada uno añadiendo costes, márgenes y complejidad.",
      "## Un recorrido que multiplica el precio",
      ...
      "La diferencia no se explica únicamente por transporte o almacenamiento. A lo largo del recorrido intervienen centrales de compra, distribuidores, plataformas logísticas y puntos de venta. Cada eslabón añade su parte, pero el conjunto genera una distorsión difícil de justificar desde fuera.",
      "El resultado es una paradoja evidente: el precio final sube, pero el valor en origen no acompaña.",
      "## Cuando producir no garantiza ganar",
      "Para el agricultor, esta dinámica tiene una consecuencia directa. Aunque el producto llegue al consumidor con un precio elevado, su margen sigue siendo mínimo. En algunos casos, incluso negativo.",
      "Esto genera situaciones difíciles de sostener. Hay campañas en las que el productor sabe de antemano que va a ingresar menos de lo que ha invertido. Aun así, continúa, muchas veces por inercia, por compromiso con la tierra o por falta de alternativas inmediatas.",
      "Ese desequilibrio no es puntual. Es estructural. Y cuando se mantiene en el tiempo, empieza a romper el sistema desde dentro.",
      "## El consumidor tampoco gana",
      "Desde el otro lado, la percepción es distinta, pero el resultado no es mejor. El consumidor paga más por productos que, en muchos casos, han perdido frescura, han recorrido largas distancias o han pasado por múltiples procesos intermedios.",
      "La sensación de encarecimiento de la cesta de la compra no siempre se traduce en mayor calidad. Y lo más relevante: ese incremento no está beneficiando directamente a quien produce el alimento.",
      "Se paga más, pero no se paga mejor.",
      "## Dónde se queda el valor",
      "La clave está en entender dónde se genera y dónde se queda el valor dentro de la cadena. En un sistema tan fragmentado, gran parte del margen se concentra en los tramos intermedios, donde el producto se gestiona, se almacena, se transporta y se comercializa.",
      "Estos procesos son necesarios, pero su acumulación crea una estructura pesada, poco eficiente y difícil de optimizar desde fuera.",
      "El productor queda en el inicio, con poco poder de negociación. El consumidor en el final, con poca información. Y entre ambos, una cadena que decide gran parte del resultado.",
      "## Un problema que va más allá del precio",
      "Este modelo no solo afecta a la economía del sector. Tiene implicaciones más amplias.",
      "Cuando el agricultor no puede sostener su actividad, el campo pierde fuerza. Cuando el consumidor no puede identificar el origen ni entender el recorrido del producto, pierde criterio. Y cuando ambos extremos están desconectados, el sistema se vuelve opaco.",
      "La consecuencia es un modelo donde el precio domina, pero no explica realmente lo que está ocurriendo.",
      "## Recuperar la conexión perdida",
      "Frente a esta realidad, el reto no es eliminar la cadena, sino hacerla más transparente y equilibrada. Reducir la distancia entre quien produce y quien consume no es solo una cuestión logística, sino también informativa.",
      "Cuando el consumidor puede entender cómo se forma el precio, qué hay detrás de un producto y quién participa en su recorrido, cambia su forma de elegir. Y cuando ese cambio se produce de forma progresiva, el sistema empieza a ajustarse.",
      "No de forma inmediata, pero sí en una dirección más coherente.",
      "## Una paradoja que define el sistema",
      "El hecho de que el agricultor cobre poco mientras el consumidor paga mucho no es una anomalía puntual. Es uno de los síntomas más claros de cómo funciona actualmente el sistema alimentario.",
      "Un sistema donde producir no siempre garantiza rentabilidad, y donde pagar más no siempre implica recibir mejor.",
      "Entender esta paradoja es el primer paso para empezar a cuestionarla. El segundo: comenzar a acercarse, cada vez más, al productor.",
    ],
    referencias: [
      "Ministerio de Agricultura, Pesca y Alimentación (MAPA) (2023). Informe de la cadena alimentaria en España.",
      "Comisión Nacional de los Mercados y la Competencia (CNMC) (2020). Estudio sobre la cadena de distribución alimentaria.",
      "FAO (2021). Food supply chain and market structure analysis.",
      "OECD (2022). Agricultural markets and price transmission.",
    ],
  },
];
