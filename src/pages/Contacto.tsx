...
const Contacto = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden" style={{ backgroundColor: C.paper }}>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden" style={{ background: `linear-gradient(90deg, ${C.cream} 0%, ${C.cream} 44%, rgba(245,240,232,0.9) 58%, rgba(245,240,232,0.22) 100%)` }}>
          <div
            className="absolute inset-y-0 right-0 hidden w-[58%] md:block"
            style={{
              backgroundImage:
                "linear-gradient(90deg, rgba(245,240,232,1) 0%, rgba(245,240,232,0.76) 30%, rgba(245,240,232,0.16) 62%), url('/lovable-uploads/contact-hero-reference.png')",
              backgroundSize: "cover",
              backgroundPosition: "center right",
            }}
            aria-hidden="true"
          />
          <div className={`${pageShell} relative z-10 py-10 md:py-12 lg:py-14`}>
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-xl text-[16px] leading-[1.65] md:text-[18px]" style={{ color: "#201812" }}>
        ...
        <section className={`${pageShell} pt-9 pb-16 md:pt-10`}>
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
            <div className="rounded-lg border p-5 md:p-8" style={{ backgroundColor: "rgba(255,250,241,0.92)", borderColor: `${C.beige}66`, boxShadow: "0 18px 44px rgba(61,43,31,0.08)" }}>
              <h2 className="mb-6 font-bold" style={{ color: C.brown, fontFamily: editorialFont, fontSize: "clamp(1.45rem, 2.4vw, 1.9rem)" }}>
                Envíanos un mensaje
              </h2>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={handleChange}
                      className="h-11 w-full appearance-none rounded-md border px-4 pr-11 text-sm outline-none"
                      style={inputStyle}
                    >
                ...
                <Button type="submit" disabled={loading} className="h-11 gap-3 px-7" style={{ backgroundColor: C.olive, color: C.card }}>
                  {loading ? (
                    <>
              ...
              <p className="mx-auto mt-7 max-w-2xl text-center text-xs leading-relaxed" style={{ color: C.inkMuted }}>
            ...
            <aside className="space-y-5">
              <div className="rounded-lg border p-6 md:p-7" style={{ backgroundColor: "rgba(255,250,241,0.92)", borderColor: `${C.beige}66`, boxShadow: "0 18px 44px rgba(61,43,31,0.08)" }}>
                <h2 className="mb-7 font-bold" style={{ color: C.brown, fontFamily: editorialFont, fontSize: "clamp(1.45rem, 2.4vw, 1.9rem)" }}>
