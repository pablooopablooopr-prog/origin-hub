            ...
            <Card className="border-0 shadow-sm">
              ...
              <CardContent>
                <p className="text-lg text-muted-foreground text-center max-w-4xl mx-auto leading-relaxed">
                  En ORIGEN creemos que cada producto tiene una historia que merece ser contada. 
                  Nuestra misión es conectar a consumidores conscientes con negocios auténticos 
                  que mantienen vivas las tradiciones ancestrales, preservando técnicas artesanales 
                  y valores fundamentales como la sostenibilidad y el comercio justo. 
                  Construimos puentes entre lo auténtico y quienes lo valoran.
                </p>
              </CardContent>
            </Card>
          </div>
