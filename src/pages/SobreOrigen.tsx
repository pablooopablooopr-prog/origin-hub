...
const SobreOrigen = () => {
  ...
  return <div className="min-h-screen flex flex-col" style={{ backgroundImage: "url('/textures/adobe-wall.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundAttachment: "fixed" }}>
      <Header />
      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 md:py-28 overflow-hidden" style={{ background: "rgba(230,210,170,0.72)" }}>
          ...
          <div className="container relative z-10 text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed font-light" style={{ fontFamily: "'Playfair Display', 'Cormorant Garamond', Georgia, serif", color: "#5a3e20" }}>
        ...
        {/* Misión */}
        <section className="py-16 md:py-20" style={{ background: "rgba(245,238,218,0.82)" }}>
        ...
        <section className="py-16 md:py-20" style={{ background: "rgba(245,238,218,0.75)" }}>
