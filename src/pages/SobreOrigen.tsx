...
const timeline = [
  {
    year: "2024",
    title: "Nacimiento de RITMORIGEN",
    ...
    <div className="min-h-screen overflow-x-hidden" style={{ backgroundColor: C.cream, color: C.brown }}>
      ...
      <main>
        <section className="relative overflow-hidden border-b" style={{ borderColor: "rgba(95,74,54,0.08)", backgroundColor: C.paper }}>
          ...
          <div className={`${pageShell} relative z-10 flex min-h-[455px] flex-col items-start justify-center py-8 lg:py-10`}>
            <div className="relative z-10 max-w-xl">
              ...
              <p className="max-w-[520px] text-[17px] leading-[1.8]" style={{ color: "#221914" }}>
                RITMORIGEN nace para dar visibilidad a quienes producen, cocinan y cuidan el territorio. Conectamos lo auténtico con quienes lo valoran, preservando tradiciones y construyendo un futuro más justo y sostenible.
              </p>

              <Button asChild className="mt-6 h-11 px-7 shadow-md" style={{ backgroundColor: C.olive, color: C.paper }}>
            ...
            <img
              ...
              className="mt-8 block min-h-[220px] w-full object-cover md:hidden"
              loading="eager"
            />
          </div>
        </section>

        <section className="py-6 md:py-8" style={{ backgroundColor: C.paper }}>
          <div className={pageShell}>
            ...
            <div className="relative grid gap-7 md:grid-cols-3">
              ...
              {timeline.map((item, index) => {
                ...
                return (
                  <article key={item.year} className="relative rounded-lg border px-7 pb-5 pt-6 text-center" style={{ backgroundColor: C.card, borderColor: C.line }}>
                    ...
                    <h2 className="mt-4 font-bold" style={{ fontFamily: SERIF, fontSize: "1.32rem" }}>
                      {item.title}
                    </h2>
                    <p className="mx-auto mt-3 max-w-[260px] text-[15px] leading-[1.55]" style={{ color: "#231916" }}>
                      {item.text}
                    </p>
                    <Icon className="mx-auto mt-5 h-10 w-10 stroke-[1.35]" style={{ color: C.gold }} />
                  </article>
                );
              })}
            </div>
        ...
        <section id="mision" className="py-5 md:py-8" style={{ backgroundColor: C.paper }}>
          <div className={`${pageShell} grid gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-center`}>
            ...
            <div>
              ...
              <p className="text-[16px] leading-[1.85]" style={{ color: "#231916" }}>
                En RITMORIGEN sabemos que cada producto tiene una historia que merece ser contada. Nuestra misión es conectar a consumidores conscientes con negocios auténticos que mantienen vivas las tradiciones, preservando técnicas artesanales y valores como la sostenibilidad y el comercio justo.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className={pageShell}>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {values.map((item) => {
                const Icon = item.icon;
                return (
                  <article key={item.title} className="rounded-lg border px-8 py-6 text-center" style={{ backgroundColor: C.card, borderColor: C.line }}>
                    <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-full" style={{ backgroundColor: "rgba(169,120,43,0.15)" }}>
                      <Icon className="h-7 w-7 stroke-[1.7]" style={{ color: C.gold }} />
                    </div>
                    <h2 className="font-bold" style={{ fontFamily: SERIF, fontSize: "1.45rem" }}>
                      {item.title}
                    </h2>
                    <p className="mx-auto mt-3 max-w-[280px] text-[15px] leading-[1.55]" style={{ color: "#231916" }}>
                      {item.text}
                    </p>
                  </article>
                );
        ...
        <section className="relative overflow-hidden" style={{ backgroundColor: "#41511F" }}>
          <div
            ...
            aria-hidden="true"
          />
          <div className={`${pageShell} relative z-10 py-7 md:py-8`}>
            <div className="max-w-md">
              <h2 className="font-bold text-[#FBF5EA]" style={{ fontFamily: SERIF, fontSize: "clamp(2rem, 3.6vw, 2.8rem)" }}>
                Únete al movimiento
              </h2>
              <p className="mt-2 text-[16px] leading-[1.55] text-[#FBF5EA]/90">
                Forma parte de nuestra comunidad de negocios auténticos y consumidores conscientes.
              </p>
              <Button asChild className="mt-5 h-11 bg-[#FBF5EA] px-7 text-[#2F2118] hover:bg-[#F4EDE1]">
                <Link to="/soy-empresa">
                  Quiero formar parte
