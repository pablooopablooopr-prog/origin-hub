...
const SoyEmpresa = () => {
  ...
  const criteria = ["Productos artesanos o tradicionales", "Sin aditivos químicos innecesarios", "Métodos de producción auténticos", "Compromiso con la calidad sobre la cantidad", "Negocio familiar o local establecido"];
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
              Únete a la primera comunidad que está transformando el comercio local y nacional            
            </p>
