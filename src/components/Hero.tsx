    ...
    <section className="min-h-[93vh] flex items-center justify-center relative overflow-hidden pt-0">
      ...
      >
        ...
        <div className="w-full flex flex-col items-center text-center px-6 py-4">
          <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-3xl mx-auto leading-relaxed font-medium" style={{ fontFamily: "'Playfair Display', 'Cormorant Garamond', Georgia, serif", fontSize: "inherit" }}>
            Negocios tradicionales. Calidad real. Comunidad nacional.
          </p>

          <p className="text-white text-lg md:text-lg text-center leading-relaxed max-w-3xl mx-auto mb-12" style={{ fontFamily: "'Cormorant Garamond', 'Playfair Display', Georgia, serif", fontSize: "inherit", textShadow: "0 1px 6px rgba(0,0,0,0.3)" }}>
