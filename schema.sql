...
CREATE OR REPLACE FUNCTION "public"."approve_company"("p_company_id" "uuid") RETURNS "void"
...
ALTER FUNCTION "public"."approve_company"("p_company_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."companies_protect_admin_fields"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
  -- Proteger user_id siempre
  if tg_op = 'UPDATE' then
    if new.user_id is distinct from old.user_id and not is_admin() then
      raise exception 'Not allowed: cannot change user_id';
    end if;

    -- Proteger status: solo admin puede cambiarlo
    if new.status is distinct from old.status and not is_admin() then
      raise exception 'Not allowed: only admin can change status';
    end if;
  end if;

  -- En INSERT: forzar status='pending' para no-admin
...
ALTER FUNCTION "public"."companies_protect_admin_fields"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select public.current_user_owns_company(p_company_id)
     and public.is_company_approved(p_company_id);
$$;


ALTER FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select exists(
...
ALTER FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare r record;
...
ALTER FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_my_company_status"() RETURNS "text"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select c.status
...
ALTER FUNCTION "public"."get_my_company_status"() OWNER TO "postgres";
...
begin
  ...
  if v_type = 'customer' then
    insert into public.customers (user_id, email, full_name, created_at)
    values (
      new.id,
      new.email,
  ...
  if v_type = 'company' then
    insert into public.companies (user_id, email, company_name, status, created_at)
    values (
      new.id,
      new.email,
...
CREATE OR REPLACE FUNCTION "public"."is_company_approved"("p_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select coalesce((
    select upper(coalesce(c.status,'')) = 'APPROVED'
    from public.companies c
    where c.id = p_company_id
    limit 1
  ), false);
...
ALTER FUNCTION "public"."is_company_approved"("p_company_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
  ...
  -- opcional: si quieres guardar motivo en algún sitio y NO tienes columna, lo dejamos fuera.
  -- Si tienes una columna rejection_reason, dímelo y lo metemos.
end;
$$;


ALTER FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."routes" (
    ...
    "moderation_status" "text" DEFAULT 'pending_review'::"text" NOT NULL
);
...
CREATE OR REPLACE VIEW "public"."company_packs_public" WITH ("security_invoker"='on') AS
 SELECT "id",
    "company_id",
    "template_id",
    "title",
...
CREATE OR REPLACE VIEW "public"."routes_public" WITH ("security_invoker"='on') AS
 SELECT "id",
    "region_id",
    "title",
    "slug",
...
CREATE UNIQUE INDEX "companies_slug_unique_not_null" ON "public"."companies" USING "btree" ("slug") WHERE ("slug" IS NOT NULL);
...
CREATE UNIQUE INDEX "companies_user_id_unique_not_null" ON "public"."companies" USING "btree" ("user_id") WHERE ("user_id" IS NOT NULL);
...
CREATE UNIQUE INDEX "customers_user_id_unique" ON "public"."customers" USING "btree" ("user_id");
...
CREATE UNIQUE INDEX "ux_pack_payments_order_id" ON "public"."pack_payments" USING "btree" ("order_id");
...
CREATE OR REPLACE TRIGGER "trg_companies_protect_admin_fields" BEFORE INSERT OR UPDATE ON "public"."companies" FOR EACH ROW EXECUTE FUNCTION "public"."companies_protect_admin_fields"();
...
CREATE POLICY "Creator delete own routes" ON "public"."routes" FOR DELETE TO "authenticated" USING (("creator_id" = "auth"."uid"()));



CREATE POLICY "Creator insert own routes" ON "public"."routes" FOR INSERT TO "authenticated" WITH CHECK (("creator_id" = "auth"."uid"()));



CREATE POLICY "Creator read own routes" ON "public"."routes" FOR SELECT TO "authenticated" USING (("creator_id" = "auth"."uid"()));



CREATE POLICY "Creator update own routes" ON "public"."routes" FOR UPDATE TO "authenticated" USING (("creator_id" = "auth"."uid"())) WITH CHECK (("creator_id" = "auth"."uid"()));
...
CREATE POLICY "Customers can insert own row" ON "public"."customers" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Customers can view own row" ON "public"."customers" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Public read public active routes" ON "public"."routes" FOR SELECT TO "authenticated", "anon" USING (((COALESCE("is_public", false) = true) AND (COALESCE("is_active", false) = true) AND (COALESCE("is_demo", false) = false)));
...
CREATE POLICY "companies_admin_select_all" ON "public"."companies" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "companies_public_select_approved" ON "public"."companies" FOR SELECT USING (("upper"(COALESCE("status", ''::"text")) = 'APPROVED'::"text"));



CREATE POLICY "companies_select_own_if_approved" ON "public"."companies" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR (("user_id" = "auth"."uid"()) AND ("upper"(COALESCE("status", ''::"text")) = 'APPROVED'::"text"))));



CREATE POLICY "companies_update_own_if_approved" ON "public"."companies" FOR UPDATE TO "authenticated" USING (("public"."is_admin"() OR (("user_id" = "auth"."uid"()) AND ("upper"(COALESCE("status", ''::"text")) = 'APPROVED'::"text")))) WITH CHECK (("public"."is_admin"() OR (("user_id" = "auth"."uid"()) AND ("upper"(COALESCE("status", ''::"text")) = 'APPROVED'::"text"))));
...
CREATE POLICY "company_packs_company_all_approved" ON "public"."company_packs" TO "authenticated" USING (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id"))) WITH CHECK (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id")));



CREATE POLICY "company_packs_public_select_published_active" ON "public"."company_packs" FOR SELECT USING ((("status" = 'published'::"text") AND (COALESCE("is_active", false) = true) AND (COALESCE("is_demo", false) = false)));
...
CREATE POLICY "customers_auth_insert_own" ON "public"."customers" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "customers_auth_select_own" ON "public"."customers" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "customers_auth_update_own" ON "public"."customers" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "customers_owner_update_welcome_sent_at" ON "public"."customers" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "order_items_company_select_approved" ON "public"."order_items" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."company_packs" "cp"
     JOIN "public"."companies" "co" ON (("co"."id" = "cp"."company_id")))
  WHERE (("cp"."id" = "order_items"."pack_id") AND ("co"."user_id" = "auth"."uid"()) AND "public"."is_company_approved"("co"."id"))))));



CREATE POLICY "order_items_customer_select_own" ON "public"."order_items" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
...
CREATE POLICY "orders_company_select_approved" ON "public"."orders" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id")));



CREATE POLICY "orders_customer_insert_own" ON "public"."orders" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."customers" "c"
  WHERE (("c"."id" = "orders"."customer_id") AND ("c"."user_id" = "auth"."uid"())))));



CREATE POLICY "orders_customer_select_own" ON "public"."orders" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."customers" "c"
  WHERE (("c"."id" = "orders"."customer_id") AND ("c"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "pack_analytics_company_select_approved" ON "public"."pack_analytics" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."company_packs" "cp"
  WHERE (("cp"."id" = "pack_analytics"."pack_id") AND "public"."current_user_owns_approved_company"("cp"."company_id"))))));
...
CREATE POLICY "pack_elements_company_all_approved" ON "public"."pack_elements" TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."company_packs" "cp"
  WHERE (("cp"."id" = "pack_elements"."pack_id") AND "public"."current_user_owns_approved_company"("cp"."company_id")))))) WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."company_packs" "cp"
  WHERE (("cp"."id" = "pack_elements"."pack_id") AND "public"."current_user_owns_approved_company"("cp"."company_id"))))));



CREATE POLICY "pack_elements_public_select_published_pack" ON "public"."pack_elements" FOR SELECT USING (("pack_id" IN ( SELECT "company_packs"."id"
   FROM "public"."company_packs"
  WHERE (("company_packs"."status" = 'published'::"text") AND (COALESCE("company_packs"."is_active", false) = true)))));
...
CREATE POLICY "pack_payments_company_select_approved" ON "public"."pack_payments" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id")));



CREATE POLICY "pack_payments_customer_select_own" ON "public"."pack_payments" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."orders" "o"
     JOIN "public"."customers" "c" ON (("c"."id" = "o"."customer_id")))
...
CREATE POLICY "pack_payments_service_all" ON "public"."pack_payments" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "pack_products_company_all_approved" ON "public"."pack_products" TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."company_packs" "cp"
  WHERE (("cp"."id" = "pack_products"."pack_id") AND "public"."current_user_owns_approved_company"("cp"."company_id")))))) WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."company_packs" "cp"
  WHERE (("cp"."id" = "pack_products"."pack_id") AND "public"."current_user_owns_approved_company"("cp"."company_id"))))));



CREATE POLICY "pack_products_public_select_published_pack" ON "public"."pack_products" FOR SELECT USING (("pack_id" IN ( SELECT "company_packs"."id"
   FROM "public"."company_packs"
  WHERE (("company_packs"."status" = 'published'::"text") AND (COALESCE("company_packs"."is_active", false) = true)))));
...
CREATE POLICY "products_company_all_approved" ON "public"."products" TO "authenticated" USING (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id"))) WITH CHECK (("public"."is_admin"() OR "public"."current_user_owns_approved_company"("company_id")));



CREATE POLICY "products_public_select_available" ON "public"."products" FOR SELECT USING (("is_available" = true));
...
REVOKE ALL ON FUNCTION "public"."approve_company"("p_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."approve_company"("p_company_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."approve_company"("p_company_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."approve_company"("p_company_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."companies_protect_admin_fields"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."companies_protect_admin_fields"() TO "anon";
GRANT ALL ON FUNCTION "public"."companies_protect_admin_fields"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."companies_protect_admin_fields"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."current_user_owns_approved_company"("p_company_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."current_user_owns_company"("p_company_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."drop_all_policies"("p_schema" "text", "p_table" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_my_company_status"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_my_company_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_company_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_company_status"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."is_company_approved"("p_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."is_company_approved"("p_company_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_company_approved"("p_company_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_company_approved"("p_company_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_company_welcome_sent"("p_user_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_customer_welcome_sent"("p_user_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."reject_company"("p_company_id" "uuid", "p_reason" "text") TO "service_role";
...
GRANT SELECT ON TABLE "public"."company_packs" TO "anon";
